...
for name in favourite_languages.keys(): # This line tell python to put all the keys from the dictionary on favourite_languages and store them on at a time in the variable called 'name'. 
    print(name.title())
