...
# print(message)
#In line 28, it is classed as an integer therefore it won't print unless it is converted into a string. When adding 'str('variable)' it would convert an integer to a string
